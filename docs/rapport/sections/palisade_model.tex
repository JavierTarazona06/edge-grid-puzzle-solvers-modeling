...
l'instruction \texttt{for W in components}, puis à ajouter une coupe pour
chaque composante \(W\). Il ne s'agit pas de rejeter
plusieurs solutions candidates différentes en même temps, mais de rejeter
plusieurs composantes incorrectes à l'intérieur d'une même solution candidate.
Ainsi, CPLEX reçoit davantage d'information à chaque appel du
\textit{callback}.

Cette modification conserve l'exactitude de la méthode. Chaque coupe ajoutée
reste une contrainte valide de connexité : elle interdit qu'une composante
isolée reste affectée entièrement à la même région sans connexion avec le reste
de cette région. En revanche, elle renforce beaucoup la séparation dynamique,
car une seule solution candidate déconnectée permet maintenant d'ajouter
plusieurs coupes utiles.

Après cette correction, l'instance lente
