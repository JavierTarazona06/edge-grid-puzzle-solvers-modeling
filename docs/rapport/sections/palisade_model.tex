...
Dans l'implémentation de ce projet, dès qu'une région déconnectée est détectée, le \textit{callback} ajoute une coupe pour la première composante stricte trouvée puis redonne la main à CPLEX. Si d'autres composantes interdites subsistent, elles seront coupées lors d'appels ultérieurs.
...
\begin{enumerate}
    ...
    \item ajouter une coupe de connexité pour une composante interdite détectée ;
