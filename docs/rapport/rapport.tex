...
\usepackage{mathpazo}           % Police Palatino, plus lisible pour le texte et les maths
...
\usepackage{microtype}          % Amélioration de la lisibilité typographique
\usepackage{tikz}               % Schémas conceptuels
...
\fancyhead[R]{Projet : Edge Grid Puzzle Solvers Modeling}
\fancyfoot[C]{\thepage}
...
\newcommand{\degset}{\delta}
\newcommand{\binary}{\{0,1\}}
\newcommand{\card}[1]{\left|#1\right|}
\newcommand{\st}{\text{s.c.}}
...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\huge\bfseries Edge Grid Puzzle Solvers Modeling \par}
    \vspace{0.3cm}
    {\Large Projet du Graphes, Jeux et Recherche Opérationnelle\par}
    \vspace{3cm}
    {\Large Javier Andres TARAZONA \par}
    {\Large Carlos Adrian MENESES \par}
    {\Large Shebli RAKKA \par}
    {\Large  \par}
    \vspace{1.5cm}
    \textbf{Encadrants :} Zacharie ALES et Dylan LAPLACE \par
    \vfill
...
Le code source associé à ce travail est disponible dans le dépôt GitHub
suivant : \url{https://github.com/JavierTarazona06/edge-grid-puzzle-solvers-modeling}.
...
\include{sections/loopy_model}

% ====================================================
% palisade_model
% ====================================================

\include{sections/palisade_model}
